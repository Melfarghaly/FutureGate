...
if (!function_exists('parse_merge_fields')) {
	...
	//$session=$this->session->all_userdata();
	            ...
	            $web_name   =get_option("website_name_en", "SMM PANEL");
	            $copy       = get_option('copy_right_content_en',"Copyright &copy; 2021 - SmartStore");
	            
	     
	            // $web_name=get_option("website_name", "SMM PANEL");
	            // $copy=get_option('copy_right_content',"Copyright &copy; 2021 - SmartStore");
