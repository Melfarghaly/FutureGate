...
$route['order/search']                          = 'order/search';
...
$route['cron/payop']                            = 'checkout/payop/cron';
$route['cron/mercadopago']                      = 'checkout/mercadopago/cron';

// IPN url
$route['mollie_ipn']                   			= 'checkout/mollie/ipn';
$route['unitpay_ipn']                   		= 'checkout/unitpay/ipn';
$route['payeer_ipn']                   		    = 'checkout/payeer/ipn';
$route['gbprimepay_ipn']                   		= 'checkout/gbprimepay/ipn';
$route['mercadopago_ipn']                   	= 'checkout/mercadopago/ipn';
$route['payrexx_ipn']                   	    = 'checkout/payrexx/ipn';
