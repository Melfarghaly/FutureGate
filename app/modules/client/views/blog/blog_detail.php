        ...
        <div class="row">
          <div class="col-lg-9">
            <div class="blog-content">
              <div class="image-thumbnail text-center">  
                <img src="<?php echo strip_tags($blog->image)?>" alt="<?php if($lang=="en") echo strip_tags($blog->title_en); else  echo strip_tags($blog->title); ?>">
              </div>
              <h1 class="title"><?php if($lang=="en") echo strip_tags($blog->title_en); else  echo strip_tags($blog->title); ?></h1>
              <div class="post-info">
                <p>
                  <span><i class="fa fa-user"></i> <a href="javascript:void(0)" title="<?php if($lang=="en") echo get_option('website_name_en'); else  echo get_option('website_name'); ?>" rel="author"><?php if($lang=="en") echo get_option('website_name_en'); else  echo get_option('website_name'); ?></a></span>
              ...
              <div class="details">
                <?php if($lang=="en") echo html_entity_decode($blog->content_en, ENT_QUOTES); else  echo html_entity_decode($blog->content, ENT_QUOTES);?>
              </div>
            </div>
            <div class="blog-back">
          ...
          <div class="col-lg-3 mb-4 side-bar">
            ...
            <div class="widget">
              ...
              <?php
                if($lang=="en")
                    $website_name = get_option('website_name_en');
                else
