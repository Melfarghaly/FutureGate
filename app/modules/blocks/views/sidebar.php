<aside class="navbar navbar-side navbar-fixed js-sidebar" id="aside">
  ...
  <div class="flex-fill scroll-bar">
    <ul class="navbar-nav mb-md-4" id="menu">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if(segment(1) == 'tickets') echo "active"; else echo ""; ?>" href="<?php echo cn('tickets'); ?>" data-toggle="tooltip" data-placement="right" title="<?php echo lang('Tickets'); ?>">
          <span class="nav-icon">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if(segment(1) == 'payments') echo "active"; else echo ""; ?>" href="<?php echo cn('payments'); ?>" data-toggle="tooltip" data-placement="right" title="<?php echo lang('Payments'); ?>">
          <span class="nav-icon">
