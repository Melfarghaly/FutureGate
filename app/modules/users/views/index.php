<div class="page-header d-md-none">
  <h1 class="page-title">
    <i class="icon fe fe-users" aria-hidden="true"></i> <?php echo lang("Customers"); ?>
  </h1>
</div>
          ...
          <tbody>
            ...
            <tr class="tr_<?php echo strip_tags($row->ids); ?>">
              ...
              <td class="text-center">
                ...
                <div class="btn-group">
                  <a href="<?php echo cn($module."/update/".$row->ids); ?>" class="btn btn-icon btn-outline-primary ajaxModal" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("Add_Note"); ?>"><i class="fe fe-edit"></i></a>
                  <a href="<?php echo cn($module."/mail/".$row->ids); ?>" class="btn btn-icon btn-outline-primary ajaxModal" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("send_mail"); ?>"><i class="fe fe-mail"></i></a>
