              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control square" name="email_to" value="<?php echo (!empty($ticket->from) && $ticket->from != "") ? $ticket->from : ''?>">
                  </div>
                </div>  
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control square" name="subject" value="<?php echo (!empty($ticket->subject) && $ticket->subject != "") ? $ticket->subject : ''?>">
                  </div>
                </div> 
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea rows="5" class="form-control square" disabled ><?php echo (!empty($ticket->description))? html_entity_decode($ticket->description, ENT_QUOTES) : ''?></textarea>
                  </div>
                </div>    
