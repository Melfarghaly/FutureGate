        ...
        <form class="actionForm" action="<?php echo cn("$module/ajax_general_settings"); ?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <div class="form-group">
                <label class="form-label"><?php echo lang("website_name"); ?> English</label>
                <input class="form-control" name="website_name_en" value="<?php echo strip_tags(get_option('website_name_en', "SmartStore")); ?>">
              </div>  
              ...
              <div class="form-group">
                <label class="form-label"><?php echo lang("website_description"); ?> English</label>
                <textarea rows="8" name="website_desc_en" class="form-control"><?php echo strip_tags(get_option('website_desc_en', "SmartStore is the best option to get all social media services in website. Easy build Social Media Marketing Store with a unique design and business process automation")); ?>
                </textarea>
              </div>
              ...
              <div class="form-group">
                <label class="form-label"><?php echo lang("website_keywords"); ?> English</label>
                <textarea rows="8" name="website_keywords_en" class="form-control"><?php echo strip_tags(get_option('website_keywords_en', "SmartStore, smm reseller panel, smmpanel, panelsmm, create smm store, business smm, socialmedia, instagram reseller panel, create smm store, resell smm services, smm store, start smm business, cheap smm business, buy instagram followers, instagram likes, facebook followers, facebook likes, twitter likes, youtube views, soundclound")); ?>
                </textarea>
              </div>
              ...
              <div class="form-group">
                <label class="form-label"><?php echo lang("website_title"); ?> English</label>
                <input class="form-control" name="website_title_en" value="<?php echo get_option('website_title_en', "SmartStore - Social Media Marketing Store Script"); ?>">
              </div>
            </div>
            <div class="col-md-12">
              <div class="">
