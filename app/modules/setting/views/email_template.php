        ...
        <form class="actionForm" action="<?php echo cn("$module/ajax_general_settings"); ?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <div class="form-group">
                <label class="form-label"><?php echo lang("Subject"); ?> English</label>
                <input class="form-control" name="new_order_notification_send_to_customer_subject_en" value="<?php echo get_option('new_order_notification_send_to_customer_subject_en', getEmailTemplate("new_order_notification_send_to_customer")->subject); ?>">
              </div> 
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="form-label"><?php echo lang("Content"); ?> English</label>
                <textarea rows="3" name="new_order_notification_send_to_customer_content_en"class="form-control textarea_editor"><?php echo get_option('new_order_notification_send_to_customer_content_en', getEmailTemplate("new_order_notification_send_to_customer")->content); ?>
                </textarea>
              </div>
              <div class="form-group">
                <div class="small">
