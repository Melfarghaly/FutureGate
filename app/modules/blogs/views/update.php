        ...
        <form class="form actionForm" action="<?php echo strip_tags($url); ?>" data-redirect="<?php echo cn("$module/update/".$ids); ?>" method="POST">
          <div class="form-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="projectinput5"><?php echo lang('article_title'); ?> <span class="form-required"> English*</span></label>
                  <input class="form-control square" name="title_en" type="text" value="<?php echo (!empty($blog->title_en)) ? strip_tags($blog->title_en) : '';?>">
                </div>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <textarea id="editor" rows="2" class="form-control square editor" name="content" placeholder="Write conetnt in here"><?php echo (!empty($blog->content)) ? html_entity_decode($blog->content, ENT_QUOTES) : ''; ?></textarea>
                </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label for="bloginput8"><?php echo lang('article_description'); ?> <span class="form-required"> English*</span></label>
                  <textarea id="editor" rows="2" class="form-control square editor" name="content_en" placeholder="Write conetnt in here"><?php echo (!empty($blog->content_en)) ? html_entity_decode($blog->content_en, ENT_QUOTES) : ''; ?></textarea>
                </div>
              </div>
