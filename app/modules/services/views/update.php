      ...
      <div class="modal-content">
        ...
        <form class="form actionForm" action="<?php echo strip_tags($url); ?>" data-redirect="<?php echo cn($module); ?>" method="POST">
            ...
            <div class="form-body" id="add_edit_service">
              <div class="row justify-content-md-center">
                <div class="col-md-12 col-sm-12 col-xs-12">
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group emoji-picker-container">
                    <label ><?php echo lang("package_name");  ?> - English</label>
                    <input type="text" class="form-control square" name="name_en" value="<?php echo (!empty($service->name_en))? strip_tags($service->name_en): ''?>">
                  </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <select name="is_free" class="form-control square">
                      <option value="1" <?php echo ($service->is_free)? 'selected': ''?>>Allowed</option>
                      <option value="0" <?php echo (!$service->is_free)? 'selected': ''?>>Not Allowed</option>
                    </select>
                  </div>
                </div>
          ...
          <div class="modal-footer">
            <a href="<?php echo cn("provider/services"); ?>" class="btn round btn-info btn-min-width mr-1 mb-1"><?php echo lang("add_new_service_via_api"); ?></a>
...
<script>
  ...
  $(document).on("change", ".ajaxGetServiceDetail", function(){
    ...
    _rate=_rate*3.26; //to convert  KWD TO DOLLAR
