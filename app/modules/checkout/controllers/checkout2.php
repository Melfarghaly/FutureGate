...
class checkout extends MX_Controller {
	...
	public function __construct(){
		...
		$this->stspayone_key       = "YzNhZmJkMjIwMTczNThlM2E0YjliMDk4"; //test : "ZjAzMzk3MzMyNzMxOWVkMWI2NDg3ODc2"; //
	...
	public function success($id = ""){
		...
		if (!empty($transaction)) {
			...
			if (!empty($order_detail)) {
				...
				$user = $this->model->get("id, email", $this->tb_users, ['id' => $transaction->uid]);
