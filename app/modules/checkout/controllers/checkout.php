...
class checkout extends MX_Controller {
	...
	public function __construct(){
		...
		*/
		$this->stspayone_key       = "Y2UwN2I3M2Q0Njk1NDljOWI4ZDc3YTNl"; //"YzNhZmJkMjIwMTczNThlM2E0YjliMDk4"; //test : "ZjAzMzk3MzMyNzMxOWVkMWI2NDg3ODc2"; //
        $this->sts_redircturl      =  "https://smartroute.stspayone.com/SmartRoutePaymentWeb/SRPayMsgHandler";  //test:"https://srstaging.stspayone.com/SmartRoutePaymentWeb/SRPayMsgHandler";  //
        $this->merchant_id         = "CSC0000055";
	}
...
*/
	...
	public function generateHash($transaction_id,$amount,$lang="en"){
	  $PAYONE_SECRET_KEY = $this->stspayone_key ; // Use Yours, 
        //Please Store Your Secret Key in safe Place(eg. database) 
          ...
          $parameters['Amount'] = floatval($amount)*100; 
          ...
          $parameters['ResponseBackURL'] = "https://futuregate.store/checkout/responsePayone?lang=".$lang;  // if this url is configured for the merchant it's not required 
	...
	public function gresponseHash($response){
	  $PAYONE_SECRET_KEY = $this->stspayone_key ; // Use Yours, 
        //Please Store Your Secret Key in safe Place(eg. database) 
          ...
          $parameters['Amount']             = $response['Response_Amount'];
    ...
    public function createStsPyone($data_order,$transaction_id){
        ...
        $attributesData = array(); 
          ...
          $attributesData["MerchantID"] = $this->merchant_id; 
          $attributesData["Amount"] = floatval($data_order['price']) * 100; 
          ...
          $attributesData["ResponseBackURL"] = "https://futuregate.store/checkout/responsePayone?lang=".$lang;  
   ...
   public function responsePayone(){
    // return $_GET["paymentId"];
        ...
        $lang=$_GET['lang'];//$parameterNames['Response_Language'];
