              ...
              <form class="actionCheckoutForm" method="POST" action>
                <fieldset class="form-fieldset m-t-20">
                  ...
                  <div class="form-group">
                    ...
                    <div>
                      <img src="<?php echo BASE; ?>assets/images/visa-master-logo.png" width="30%" alt="">
					  <img src="<?php echo BASE; ?>assets/images/American-Express-Color.png" width="30%" alt="">
					  
                    </div>
                    <input type="hidden" name="payment_id" value="15">
