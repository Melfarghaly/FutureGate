...
class checkout_model extends MY_Model {
	...
	public function get_order_by_id($id){
		$this->db->select("o.id, o.quantity, o.link, s.name as service_name,s.name_en as service_name_en");
	...
	public function get_service_detail_by($id){
		$this->db->select('s.*, cate.required_field,cate.required_field_en, cate.features');
