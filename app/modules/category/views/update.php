          ...
          <div class="form-body">
            <div class="row justify-content-md-center">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label >English Name <span class="form-required">*</span></label>
                  <input type="text" class="form-control square"  name="name_en" value="<?php echo (!empty($category->name_en)) ? strip_tags($category->name_en) : ''; ?>" placeholder="Instagram Followers (Must be be greater than 2 words)">
                </div>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label ><?php echo lang("name_of_required_field"); ?>  English
                    <span class="form-required">*</span>
                    <i class="fa fa-question-circle" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Display the name of required field on Check out form page" data-title="Details"></i> 
                  </label>
                  <input type="text" class="form-control square"  name="required_field_en" value="<?php echo (!empty($category->required_field_en))? strip_tags($category->required_field_en) : 'link'?>">
                </div>
              </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                  <label>Page Title Engilsh</label>
                  <input  class="form-control square" type="text" name="page_title_en" value="<?php echo (!empty($category->page_title_en)) ? strip_tags($category->page_title_en) : ''; ?>">
                </div>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <textarea rows="3" class="form-control square" name="meta_keywords_en"><?php echo (!empty($category->meta_keywords_en)) ? strip_tags($category->meta_keywords_en) : ''; ?></textarea>
                </div>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label>Meta description Engilsh</label>
                  <textarea rows="3" class="form-control square" name="meta_description_en"><?php echo (!empty($category->meta_description_en)) ? strip_tags($category->meta_description_en) : ''; ?></textarea>
                </div>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <textarea id="editor" rows="2" class="form-control square editor" name="content" placeholder="Write conetnt in here"><?php echo (!empty($category->content)) ? $category->content : ''; ?></textarea>
                </div>
              </div>
              
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label for="bloginput8"><?php echo lang('article_description'); ?> English</label>
                  <textarea id="editor" rows="2" class="form-control square editor" name="content_en" placeholder="Write conetnt in here"><?php echo (!empty($category->content_en)) ? $category->content_en : ''; ?></textarea>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group-item">
                  ...
                  <div class="g-items-header">
                      <div class="row">
                        <div class="col-md-3"> Icon name</div>
                        <div class="col-md-4">Content</div>
                        <div class="col-md-4">Content English</div>
                    ...
                    ?>
                      <div class="item" data-number="<?php echo $i; ?>">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <textarea name="features[<?php echo $key; ?>][content_en]" class="form-control full-h"><?php echo (isset($feature->content_en)) ? $feature->content_en : ''; ?></textarea>
                          </div>
                  ...
                  <div class="g-more d-none">
                    <div class="item" data-number="__number__">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <textarea __name__="features[__number__][content_]" class="form-control full-h" placeholder="..."></textarea>
                        </div>
                        <div class="col-md-4">
                          <textarea __name__="features[__number__][content_en]" class="form-control full-h" placeholder="..."></textarea>
                        </div>
                        <div class="col-md-1 text-center">
                          <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                        </div>
