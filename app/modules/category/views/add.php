    ...
    <form class="form actionForm" action="<?php echo strip_tags($url); ?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fa fa-edit"></i> Add new</h3>
        ...
        <div class="card-body">
          <div class="form-body">
            <div class="row justify-content-md-center">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>Page Title <span class="form-required">*</span></label>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label>Meta Keywords <span class="form-required">*</span></label>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label>Meta description <span class="form-required">*</span></label>
              ...
              <div class="col-md-12">
                <div class="form-group-item">
                  ...
                  <div class="g-items">
                    <?php
                      $features_encode = get_default_category_features();
                      $features_decode = json_decode($features_encode);
                      if (!empty($features_decode)) {
                        foreach ($features_decode as $key => $feature) {
                    ?>
                      <div class="item" data-number="<?php echo $key; ?>">
                        <div class="row">
                          <div class="col-md-5">
                            <input type="text" name="features[<?php echo $key; ?>][icon]" class="form-control" value="<?php echo $feature->icon; ?>">
                          </div>
                          <div class="col-md-6">
                            <textarea name="features[<?php echo $key; ?>][content]" class="form-control full-h"><?php echo $feature->content; ?></textarea>
                          </div>
                          <div class="col-md-1 text-center g-btn-add">
...
<script>
  ...
  $(document).on("keyup","input[type=text][name=name]", function(){
    ...
    $(".c-update-form input[name=url_slug]").val(_value);  
  });
